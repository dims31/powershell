...
Write-Host "-----Generateur de QR Code basé sur l'API google----"-ForegroundColor Cyan -BackgroundColor Black
Write-Host "---------------------------------------------------"-ForegroundColor Cyan -BackgroundColor Black
Write-Host ""

$data = Read-Host "Veuillez rentrer le texte à générer"

New-QR -Message $data

Write-Host "Merci d'avoir utilisé le générateur de QR code" -ForegroundColor Cyan -BackgroundColor Black

Write-Host "Le QR Code est disponible ici : $($env:userprofile)\AppData\Local\Temp\QR.png" -ForegroundColor Cyan -BackgroundColor Black
